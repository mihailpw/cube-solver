...
public class GreedyBox3FillerTests
{
    ...
    [TestCase("1000 1000 1000", "1:0 2:0 4:0 8:46501 16:0 32:2791 64:631 128:127 256:19 512:1", ExpectedResult = 50070)]
    ...
    [TestCase("4 4 4", "3:99 2:99 1:99", ExpectedResult = 38)] // real minimum is still 8
